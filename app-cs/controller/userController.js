angular.module('business-insights').controller('commonController', ['$state', 'commonService', '$localStorage', '$window', '$timeout', '$rootScope', 'ngDialog', '$scope', '$location', '$http',
...
angular.module('business-insights').controller('userController', ['$alert', '$state', '$localStorage', '$window', '$timeout', '$rootScope', 'ngDialog', '$scope', '$location', '$http', 'commonService', 'billingService',
